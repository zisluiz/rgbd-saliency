...
void RgbdSaliency::processWrite(boost::chrono::system_clock::time_point start, fs::path rgb_path_p, fs::path savepath, cv::Size original_size, const boost::shared_ptr<Blob<float>> slic_blob, const float* score_ptr) {
